...
sbrkmuch(char *s)
{
  // The +4096 ensures the process's VM space ends with a regular page, not a
  // superpage. This way, a solution with superpages still matches the expected
  // behavior around allocation/deallocation and clearing old data
  enum { BIG=100*1024*1024 + 4096 };
