...
forktest(void)
{
  ...
  36:	3ee50513          	addi	a0,a0,1006 # 420 <kpgtbl+0xc>
  ...
  58:	3dc50513          	addi	a0,a0,988 # 430 <kpgtbl+0x1c>
  5c:	fa5ff0ef          	jal	ra,0 <print>
    exit(1);
  60:	4505                	li	a0,1
  62:	2e6000ef          	jal	ra,348 <exit>
      exit(0);
  66:	2e2000ef          	jal	ra,348 <exit>
  if(n == N){
  ...
  94:	3f050513          	addi	a0,a0,1008 # 480 <kpgtbl+0x6c>
  ...
  ac:	3a850513          	addi	a0,a0,936 # 450 <kpgtbl+0x3c>
  b0:	f51ff0ef          	jal	ra,0 <print>
      exit(1);
  b4:	4505                	li	a0,1
  b6:	292000ef          	jal	ra,348 <exit>
    print("wait got too many\n");
  ba:	00000517          	auipc	a0,0x0
  be:	3ae50513          	addi	a0,a0,942 # 468 <kpgtbl+0x54>
  c2:	f3fff0ef          	jal	ra,0 <print>
    exit(1);
  c6:	4505                	li	a0,1
  c8:	280000ef          	jal	ra,348 <exit>
...
stat(const char *n, struct stat *st)
{
 ...
 230:	84aa                	mv	s1,a0
  ...
  r = fstat(fd, st);
 232:	85ca                	mv	a1,s2
 234:	16c000ef          	jal	ra,3a0 <fstat>
 238:	892a                	mv	s2,a0
  close(fd);
 23a:	8526                	mv	a0,s1
 23c:	134000ef          	jal	ra,370 <close>
  return r;
}
 240:	854a                	mv	a0,s2
